...
import {
  FindMyTransactionQuery,
  TransactionStatus,
  useFindMyTransactionQuery,
...
export function TransactionsTable() {
  ...
  const { data, loading: isLoadingTransactions } = useFindMyTransactionQuery();
  const transactions = data?.findMyTransaction ?? [];

  const transactionsColumns: ColumnDef<
    FindMyTransactionQuery["findMyTransaction"][0]
  >[] = [
    {
